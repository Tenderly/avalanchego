...
// Source: github.com/tenderly/avalanchego/message (interfaces: OutboundMessage)
//
// Generated by this command:
//
//	mockgen -package=message -destination=message/mock_message.go github.com/tenderly/avalanchego/message OutboundMessage
//
