...
// Source: github.com/tenderly/avalanchego/vms/platformvm/fx (interfaces: Fx,Owner)
//
// Generated by this command:
//
//	mockgen -package=fx -destination=vms/platformvm/fx/mock_fx.go github.com/tenderly/avalanchego/vms/platformvm/fx Fx,Owner
//
