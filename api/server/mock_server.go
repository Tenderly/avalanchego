...
// Source: github.com/tenderly/avalanchego/api/server (interfaces: Server)
//
// Generated by this command:
//
//	mockgen -package=server -destination=api/server/mock_server.go github.com/tenderly/avalanchego/api/server Server
//
