...
// Source: github.com/tenderly/avalanchego/x/sync (interfaces: NetworkClient)
//
// Generated by this command:
//
//	mockgen -package=sync -destination=x/sync/mock_network_client.go github.com/tenderly/avalanchego/x/sync NetworkClient
//
