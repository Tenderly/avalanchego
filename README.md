...
```sh
git clone git@github.com:tenderly/avalanchego.git
cd avalanchego
```
...
Download the [latest build](https://github.com/tenderly/avalanchego/releases/latest) for your operating system and architecture.
...
Please refer to our [Security Policy](SECURITY.md) and [Security Advisories](https://github.com/tenderly/avalanchego/security/advisories).
