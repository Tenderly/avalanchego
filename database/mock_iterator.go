...
// Source: github.com/tenderly/avalanchego/database (interfaces: Iterator)
//
// Generated by this command:
//
//	mockgen -package=database -destination=database/mock_iterator.go github.com/tenderly/avalanchego/database Iterator
//
