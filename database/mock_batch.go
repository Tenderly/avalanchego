...
// Source: github.com/tenderly/avalanchego/database (interfaces: Batch)
//
// Generated by this command:
//
//	mockgen -package=database -destination=database/mock_batch.go github.com/tenderly/avalanchego/database Batch
//
